...
The implementation includes checkpoint restore tests, a real Kafka-to-databases recovery/replay drill, deterministic failure injection, verified Kafka consumer-offset lag, load/backpressure/soak gates, strict schema contracts, warnings-as-errors compilation, and security/coverage CI. Every public claim is tied to reproducible evidence in [docs/claims-and-evidence.md](docs/claims-and-evidence.md).
